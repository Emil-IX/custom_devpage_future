        ...
        <div id="proyects" className="proyects_container">
            ...
            <div className="proyects-content">
                ...
                <div className="pro_element appearleft2">
                    ...
                    <a href="https://github.com/Emil-IX/Mentor-Clock">View in github</a>
                    <div className="pro_tags">
                        <p>HTML</p>
                        <p>CSS</p>
                        <p>Javascripts</p>
                ...
                <div className="pro_element appearright">
                    ...
                    <div className="gitLinks">
                        <a href="https://github.com/Emil-IX/Pokemon_Api_shynidex">View in github</a>
                        <img src="./links.png" alt="link" onClick={()=> navigate('https://emil-ix.github.io/Pokemon_Api_shynidex/')} />
                    </div>
                    <div className="pro_tags">
                        <p>HTML</p>
                        <p>CSS</p>
